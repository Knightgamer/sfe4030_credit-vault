    ...
    <div class="homepage">
        ...
        <div class="button-container">
            <div class="navigation">
                <a href="add_client.php" class="nav-button"><span class="icon">➕</span>Add New Client</a>
                <a href="view_clients.php" class="nav-button"><span class="icon">👀</span>View Clients</a>
                <a href="generate_pdf.php" class="nav-button"><span class="icon">📊</span>Generate Report</a>
