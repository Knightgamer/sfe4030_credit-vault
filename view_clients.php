...
<body>
    ...
    <a class="action-button edit-button" href="edit.php?id={$row['id']}"><i class="fas fa-edit"></i></a>
    <a class="action-button delete-button" data-client-id="{$row['id']}"><i class="fas fa-trash-alt"></i></a>
</td>
